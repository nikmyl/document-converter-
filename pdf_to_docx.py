...
Converts PDF documents to Word files (.docx) by chaining through Markdown
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Convert PDF documents to Word files (.docx)',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  %(prog)s document.pdf
  %(prog)s document.pdf -o output.docx
  %(prog)s *.pdf
        """
    )
